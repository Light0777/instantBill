...
export default function Home() {
  ...
  <div className="relative">
    <div className="flex items-end justify-center gap-2 mb-2">
      <span className="text-6xl font-syne font-extrabold text-white">₹4,999</span>
    </div>
    <p className="text-gray-500 mb-2">One-time purchase · Lifetime license</p>
    <p className="text-green-500 text-sm mb-8">
      Optional yearly support ₹1,000 (Total with support: ₹5,999)
    </p>
    ...
    <ul className="text-left space-y-3 mb-8">
      {[
        ...
        "Free setup support (limited period)",
      ].map((item) => (
